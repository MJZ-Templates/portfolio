...
public enum ErrorCode {
  ...
  METHOD_NOT_ALLOWED(40500, HttpStatus.METHOD_NOT_ALLOWED, "Unsupported HTTP method."),

  // Not Found Error
  NOT_FOUND_END_POINT(40400, HttpStatus.NOT_FOUND, "API endpoint does not exist."),
  NOT_FOUND_RESOURCE(40400, HttpStatus.NOT_FOUND, "The requested resource does not exist."),
  NOT_FOUND_LOGIN_USER(40401, HttpStatus.NOT_FOUND, "Logged-in user does not exist."),
  NOT_FOUND_AUTHORIZATION_HEADER(40401, HttpStatus.NOT_FOUND, "Authorization header is missing."),
  ...
  INVALID_ARGUMENT(40001, HttpStatus.BAD_REQUEST, "Invalid request argument."),
  ...
  BAD_REQUEST_PARAMETER(40005, HttpStatus.BAD_REQUEST, "Invalid request parameter."),
  BAD_REQUEST_JSON(40006, HttpStatus.BAD_REQUEST, "Invalid JSON format."),
  ...
  TOKEN_TYPE_ERROR(40104, HttpStatus.UNAUTHORIZED, "Token type is either incorrect or missing."),
